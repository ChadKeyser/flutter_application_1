...
class _App1PageState extends State<App1Page> {
  ...
  Widget _buildButton(String value, double fontSize) {
    return AspectRatio(
      aspectRatio: 1,
  ...
  Widget _buildBackspaceBar(bool isNarrow) {
    return Padding(
        ...
        child: Center(
          child: ConstrainedBox(
            constraints: const BoxConstraints(
              maxWidth: 400, // restricts the calculator width for desktop
            ),
            child: LayoutBuilder(
